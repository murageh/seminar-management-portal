...
export const FullScreenLoader = () => {
    return (
        <div className="fixed left-0 top-0 z-50 block h-full w-full bg-slate-200 opacity-75" id={"full-screen-loader"}>
            <span
                className="r-4 relative top-1/2 mx-auto my-0 block h-0 w-0 text-green-500 opacity-75"> <div
                role="status"> <svg
                ...
                fill="currentFill"/> </svg> <span className="sr-only">Loading...</span> </div>
            </span>
        </div>
    );
}
