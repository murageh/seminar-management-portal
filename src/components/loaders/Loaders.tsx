...
export const FullScreenLoader = () => {
    return (
        <div className="fixed left-0 top-0 z-50 block h-full w-full bg-slate-200 opacity-75"><span
            className="r-4 relative top-1/2 mx-auto my-0 block h-0 w-0 text-green-500 opacity-75"> <div role="status"> <svg
            aria-hidden="true" className="mr-8 h-8 w-8 animate-spin fill-blue-600 text-gray-200 dark:text-gray-600"
            ...
            fill="currentFill"/> </svg> <span className="sr-only">Loading...</span> </div> </span></div>
    );
}
